...
$query=mysqli_query($con,"update tblpostsfptv set PostTitle='$posttitle',CategoryId='$catid',SubCategoryId='$subcatid',PostDetails='$postdetails',PostUrl='$url',Is_Active='$status' where id='$postid'");
if($query)
{
$msg="Post updated ";
}
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select tblpostsfptv.id as postid,tblpostsfptv.PostImage,tblpostsfptv.PostTitle as title,tblpostsfptv.PostDetails,tblcategory.CategoryName as category,tblcategory.id as catid,tblsubcategory.SubCategoryId as subcatid,tblsubcategory.Subcategory as subcategory from tblpostsfptv left join tblcategory on tblcategory.id=tblpostsfptv.CategoryId left join tblsubcategory on tblsubcategory.SubCategoryId=tblpostsfptv.SubCategoryId where tblpostsfptv.id='$postid' and tblpostsfptv.Is_Active=1 ");
