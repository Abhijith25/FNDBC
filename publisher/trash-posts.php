...
$query=mysqli_query($con,"update tblpostsfptv set Is_Active=1 where id='$postid'");
if($query)
{
...
if($_GET['presid'])
{
    ...
    $query=mysqli_query($con,"delete from  tblpostsfptv  where id='$id'");
