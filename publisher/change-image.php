...
$query=mysqli_query($con,"update tblpostsfptv set PostImage='$imgnewfile' where id='$postid'");
if($query)
{
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select PostImage,PostTitle from tblpostsfptv where id='$postid' and Is_Active=1 ");
