                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="dashboard_publisher.php" class="waves-effect"><i class="mdi mdi-view-dashboard"></i> <span> Welcome Publisher ! </span> </a>
  ...
  <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="add-post_publisher.php">Add Posts</a></li>
                    ...
                    <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span>techconnect@techconnect.org <br/> </p>
                    </div>
