                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="dashboard_validator.php" class="waves-effect"><i class="mdi mdi-view-dashboard"></i> <span> Welcome Validator! </span> </a>
  ...
  <li class="has_sub">
      ...
      -->
                    ...
                    <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span>adminfnd@techconnect.com <br/> </p>
                    </div>
